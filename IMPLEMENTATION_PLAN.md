...
Exact polynomial cubic/path signed-area integration and tolerance-aware closed-path orientation are
implemented. Core geometry uses Cartesian design space (X right, Y up): CCW is positive and CW is negative.
